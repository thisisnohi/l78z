...
function SM4Util(key) {
  ...
  this.encryptData_ECB = function (plainText) {
    try {
      ...
      var keyBytes = hexToBytes(this.secretKey);
      console.log("keyBytes: " + keyBytes)

      sm4.sm4_setkey_enc(ctx, keyBytes);
      var encrypted = sm4.sm4_crypt_ecb(ctx, hexToBytes(plainText));
  ...
  this.encryptData_CBC = function (plainText) {
    try {
      ...
      var keyBytes = hexToBytes(this.secretKey);
      var ivBytes = hexToBytes(this.iv);
      console.log("keyBytes: " + keyBytes)
  ...
  function hexToBytes(hex) {
    ...
    for (var bytes = [], c = 0; c < hex.length; c += 2) {
      ...
      var b_value = parseInt(hex.substr(c, 2), 16)
      if (b_value > 128) {
        b_value = b_value - 256
      }
      bytes.push(b_value);
...
// //
// var s4 = new SM4Util();
// console.log(s4.encryptData_ECB("0123456789ABCDEFFEDCBA9876543210"));
// s4.iv = "UISwD9fW6cFh9SNS";
// console.log(s4.encryptData_CBC("0123456789ABCDEFFEDCBA9876543210"));
