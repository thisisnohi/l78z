...
public class RSAUtils2 {
    ...
    public static String encryptData(String data, PublicKey publicKey){
        return ENCODER_64.encodeToString(RSAUtils2.encryptData(data.getBytes(), publicKey));
    }
    ...
    public static String decryptData(String content, PrivateKey privateKey) throws IOException {
        return new String(RSAUtils2.decryptData((new BASE64Decoder()).decodeBuffer(content), privateKey));
    }
