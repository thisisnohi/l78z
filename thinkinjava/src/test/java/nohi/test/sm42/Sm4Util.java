...
public class Sm4Util {
    ...
    public static String generateKey() throws Exception {
        byte[] keys = generateKey(DEFAULT_KEY_SIZE);
        System.out.println("keys:" + keys.length);
        System.out.println("new String(keys):" + new String(keys));
        char[] chars = Hex.encodeHex(keys,false);
    ...
    public static String encryptEcb(String hexKey, String paramStr) {
        try {
            ...
            System.out.println("hexKey:" + hexKey.length());
            System.out.println("keyData:" + keyData.length);
            String _tmp = new String(keyData,"UTF-8");
            System.out.println("keyData16:" + _tmp);
            _tmp = new String(keyData,"GBK");
            System.out.println("keyData_GBK:" + _tmp);
