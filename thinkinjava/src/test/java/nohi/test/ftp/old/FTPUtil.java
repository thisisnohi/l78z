...
public class FTPUtil {
     ...
     * @param keyWord
     */
    public static List<File> getFiles(String server, int port, String username, String password, String directory, String keyWord) throws IOException {
        SSLSessionReuseFTPSClient ftpsClient = new SSLSessionReuseFTPSClient();
        FTPClientConfig config = new FTPClientConfig();
        ftpsClient.configure(config);
        try {
...
//            ftpsClient.connect(server);
            ...
            System.out.println("files.list:" + (null == files ? "is null" : files.size()));
